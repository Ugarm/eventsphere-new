...
class Meetup
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Feedback::class, mappedBy: 'meetup', orphanRemoval: true)]
    private Collection $feedbacks;

    /**
     * @var Collection<int, Attendees>
     */
    #[ORM\OneToMany(targetEntity: Attendees::class, mappedBy: 'meetup', orphanRemoval: true)]
    ...
    public function removeFeedback(Feedback $feedback): static
    {
        if ($this->feedbacks->removeElement($feedback)) {
            ...
            if ($feedback->getMeetup() === $this) {
                $feedback->setMeetup(null);
            }
        }
    ...
    public function removeAttendee(Attendees $attendee): static
    {
        if ($this->attendees->removeElement($attendee)) {
            // set the owning side to null (unless already changed)
            if ($attendee->getMeetup() === $this) {
                $attendee->setMeetup(null);
            }
        }
